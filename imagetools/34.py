...
Original file is located at
    https://colab.research.google.com/drive/1jGLeqb53lUXOwutCTtQwow9JzDxfCas0
"""
...
def pipeline_model(path):
    ...
    # Mô tả kiến trúc
    faceDetectionProto = '/content/drive/MyDrive/test_opencv/model/deploy.prototxt.txt.prototxt'
...
img, results = pipeline_model('/content/drive/MyDrive/test_opencv/FaceImage/1721030799_NguyenNhatHieu/image_20.jpg')
cv2_imshow(img)
